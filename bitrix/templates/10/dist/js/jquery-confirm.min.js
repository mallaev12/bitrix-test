    ...
    Jconfirm.prototype = {
        ...
        _setButtons: function () {
            ...
            $.each(this.buttons, function (key, button) {
                ...
                that.buttons[key].btnClass = button.btnClass || "";
                ...
                var button_element = $('<button type="button" class="button"></button>').html(that.buttons[key].text).addClass(that.buttons[key].btnClass).prop("disabled", that.buttons[key].isDisabled).css("display", that.buttons[key].isHidden ? "none" : "").click(function (e) {
                    e.preventDefault();
