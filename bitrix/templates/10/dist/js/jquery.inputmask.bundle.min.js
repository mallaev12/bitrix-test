...
!function (a) {
    window.Inputmask = function (a, b, c, d) {
        ...
        function g(b, c) {
            function f(b, f, g) {
                var h = !1;
                if (null !== b && "" !== b || (h = null !== g.regex, h ? (b = g.regex, b = b.replace(/^(\^)(.*)(\$)$/, "$2")) : b = "*{*}"), 1 === b.length && !1 === g.greedy && 0 !== g.repeat && (g.placeholder = ""), g.repeat > 0 || "*" === g.repeat || "+" === g.repeat) {
                ...
                var j;
                return e.prototype.masksCache[b] === d || !0 === c ? (j = {
                    mask: b,
                    ...
                    metadata: f,
                    maskLength: d
                }, !0 !== c && (e.prototype.masksCache[g.numericInput ? b.split("").reverse().join("") : b] = j, j = a.extend(!0, {}, e.prototype.masksCache[g.numericInput ? b.split("").reverse().join("") : b]))) : j = a.extend(!0, {}, e.prototype.masksCache[g.numericInput ? b.split("").reverse().join("") : b]), j
            }
        ...
        function h(f, g, i) {
            function n(a, b, c) {
                ...
                } while ((U === d || j < U) && (null !== f.fn || "" !== f.def) || b > j);
            ...
            function r(b, c, e, f) {
                var g, h = b, j = a.extend(!0, {}, o().validPositions), k = !1;
                for (o().p = b, g = c - 1; g >= h; g--)o().validPositions[g] !== d && (!0 !== e && (!o().validPositions[g].match.optionality && function (a) {
                ...
                for (p(!0), g = h + 1; g <= q();) {
                    ...
                    if (g < h && (g = h + 1), o().validPositions[g] === d && D(g))g++; else {
                        var l = t(g);
                        !1 === k && j[h] && j[h].match.def === l.match.def ? (o().validPositions[h] = a.extend(!0, {}, j[h]), o().validPositions[h].input = l.input, delete o().validPositions[g], g++) : v(h, l.match.def) ? !1 !== C(h, l.input || I(g), !0) && (delete o().validPositions[g], g++, k = !0) : D(g) || (g++, h--), h++
                    }
                }
                p(!0)
            }
            ...
            function w(b, c, e) {
                function f(c, e, g, j) {
                    function l(g, j, q) {
                        ...
                        if (k > 1e4)throw"Inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + o().mask;
                        if (k === b && g.matches === d)return m.push({match: g, locator: j.reverse(), cd: p}), !0;
                        if (g.matches !== d) {
                            if (g.isGroup && q !== g) {
                                ...
                                var u, v = g, w = [], x = m.slice(), y = j.length, z = e.length > 0 ? e.shift() : -1;
                                if (-1 === z || "string" == typeof z) {
                                    var A, B = k, C = e.slice(), D = [];
                                    if ("string" == typeof z)D = z.split(","); else for (A = 0; A < v.matches.length; A++)D.push(A);
                                    for (var E = 0; E < D.length; E++) {
                                        if (A = parseInt(D[E]), m = [], e = s(k, A, y) || C.slice(), !0 !== (g = l(v.matches[A] || c.matches[A], [A].concat(j), q) || g) && g !== d && D[D.length - 1] < v.matches.length) {
                                            ...
                                            c.matches.length > F && (g = l(c.matches[F], [F].concat(j.slice(1, j.length)), q)) && (D.push(F.toString()), a.each(m, function (a, b) {
                                        ...
                                        for (var G = 0; G < u.length; G++) {
                                            ...
                                            for (var J = 0; J < w.length; J++) {
                                                ...
                                                if ("string" != typeof z || -1 !== a.inArray(H.locator[H.alternation].toString(), D)) {
                                                    if (H.match.nativeDef === K.match.nativeDef || H.match.def === K.match.nativeDef || H.match.nativeDef === K.match.def) {
                                    ...
                                    "string" == typeof z && (w = a.map(w, function (b, c) {
                                        if (isFinite(c)) {
                                            var e = b.alternation, f = b.locator[e].toString().split(",");
                                    ...
                                    })), m = x.concat(w), k = b, n = m.length > 0, e = C.slice()
                    ...
                    for (var q = e.length > 0 ? e.shift() : 0; q < c.matches.length; q++)if (!0 !== c.matches[q].isQuantifier) {
                ...
                function g(a) {
                    return i.keepStatic && b > 0 && a.length > 1 + ("" === a[a.length - 1].match.def ? 1 : 0) && !0 !== a[0].match.optionality && !0 !== a[0].match.optionalQuantifier && null === a[0].match.fn && !/[0-9a-bA-Z]/.test(a[0].match.def) ? [s(a)] : a
                }

                var h, j = o().maskToken, k = c ? e : 0, l = c ? c.slice() : [0], m = [], n = !1, p = c ? c.join("") : "";
                if (b > -1) {
                    if (c === d) {
                        for (var q, r = b - 1; (q = o().validPositions[r] || o().tests[r]) === d && r > -1;)r--;
                ...
                }), c !== d && o().tests[b] ? g(a.extend(!0, [], m)) : (o().tests[b] = a.extend(!0, [], m), g(o().tests[b]))
            }
            ...
            function z(a, b, c) {
                var e, f;
                if (!0 === a)p(), a = 0, b = c.length; else for (e = a; e < b; e++)delete o().validPositions[e];
            ...
            function B(b, c, e) {
                for (var f, g = i.greedy ? c : c.slice(0, 1), h = !1, j = e !== d ? e.split(",") : [], k = 0; k < j.length; k++)-1 !== (f = b.indexOf(j[k])) && b.splice(f, 1);
            ...
            function C(b, c, f, g, h) {
                function j(a) {
                    var b = Y ? a.begin - a.end > 1 || a.begin - a.end == 1 : a.end - a.begin > 1 || a.end - a.begin == 1;
                    return b && 0 === a.begin && a.end === o().maskLength ? "full" : b
                }

                function k(c, e, f) {
                    var h = !1;
                    return a.each(w(c), function (k, m) {
                        for (var n = m.match, s = e ? 1 : 0, t = "", u = n.cardinality; u > s; u--)t += G(c - (u - 1));
                        if (e && (t += e), y(!0), !1 !== (h = null != n.fn ? n.fn.test(t, o(), c, f, i, j(b)) : (e === n.def || e === i.skipOptionalPartCharacter) && "" !== n.def && {
                                c: I(c, n, !0) || n.def,
                                pos: c
                            })) {
                            var v = h.c !== d ? h.c : e;
                            v = v === i.skipOptionalPartCharacter && null === n.fn ? I(c, n, !0) || n.def : v;
                            var w = c, x = y();
                            if (h.remove !== d && (a.isArray(h.remove) || (h.remove = [h.remove]), a.each(h.remove.sort(function (a, b) {
                                ...
                                if (z(!0 === B ? B : B.start, B.end, x), h.pos === d && h.c === d)return h.pos = q(), !1;
                                if ((w = h.pos !== d ? h.pos : c) !== c)return h = a.extend(h, C(w, v, !0, g)), !1
                            } else if (!0 !== h && h.pos !== d && h.pos !== c && (w = h.pos, z(c, w, y().slice()), w !== c))return h = a.extend(h, C(w, v, !0)), !1;
                            return (!0 === h || h.pos !== d || h.c !== d) && (k > 0 && p(!0), l(w, a.extend({}, m, {input: A(v, n, w)}), g, j(b)) || (h = !1), !1)
                        }
                    }), h
                }
                ...
                function l(b, c, e, f) {
                    if (f || i.insertMode && o().validPositions[b] !== d && e === d) {
                        ...
                        var k, l = !0, n = o().validPositions, r = !1, s = o().maskLength;
                        for (g = k = b; g <= j; g++) {
                            var t = h[g];
                            if (t !== d)for (var u = k; u < o().maskLength && (null === t.match.fn && n[g] && (!0 === n[g].match.optionalQuantifier || !0 === n[g].match.optionality) || null != t.match.fn);) {
                                if (u++, !1 === r && h[u] && h[u].match.def === t.match.def)o().validPositions[u] = a.extend(!0, {}, h[u]), o().validPositions[u].input = t.input, m(u), k = u, l = !0; else if (v(u, t.match.def)) {
                                    ...
                                    l = !1 !== w, k = w.caret || w.insert ? q() : u, r = !0
                                } else if (!(l = !0 === t.generatedInput) && u >= o().maskLength - 1)break;
                ...
                var u = !0, x = a.extend(!0, {}, o().validPositions);
                if (a.isFunction(i.preValidation) && !f && !0 !== g && (u = i.preValidation(y(), n, c, j(b), i)), !0 === u) {
                    if (m(n), j(b) && (P(d, e.keyCode.DELETE, b), n = o().p), n < o().maskLength && (U === d || n < U) && (u = k(n, c, f), (!f || !0 === g) && !1 === u)) {
                        var F = o().validPositions[n];
                        if (!F || null !== F.match.fn || F.match.def !== c && c !== i.skipOptionalPartCharacter) {
                            if ((i.insertMode || o().validPositions[E(n)] === d) && !D(n, !0))for (var H = n + 1, J = E(n); H <= J; H++)if (!1 !== (u = k(H, c, f))) {
                                !function (b, c) {
                                    var e = o().validPositions[c];
                                    if (e)for (var f = e.locator, g = f.length, h = b; h < c; h++)if (o().validPositions[h] === d && !D(h, !0)) {
                                        var i = w(h).slice(), j = s(i, !0), m = -1;
                    ...
                    !1 === u && i.keepStatic && !f && !0 !== h && (u = function (b, c, e) {
                        ...
                        for (k = o().validPositions[u]; u >= 0; u--)if ((j = o().validPositions[u]) && j.alternation !== d) {
                        ...
                        if (h !== d) {
                            ...
                            a.each(w(r, y ? y.locator : d, r - 1), function (f, j) {
                                ...
                                for (var k = 0; k < n.length; k++) {
                                    var u = [], w = 0, y = 0, z = !1;
                                    if (v < n[k] && (j.na === d || -1 === a.inArray(n[k], j.na.split(",")) || -1 === a.inArray(v.toString(), n))) {
                                        o().validPositions[r] = a.extend(!0, {}, j);
                                        var A = o().validPositions[r].locator;
                                        for (o().validPositions[r].locator[h] = parseInt(n[k]), null == j.match.fn ? (x.input !== j.match.def && (z = !0, !0 !== x.generatedInput && u.push(x.input)), y++, o().validPositions[r].generatedInput = !/[0-9a-bA-Z]/.test(j.match.def), o().validPositions[r].input = j.match.def) : o().validPositions[r].input = x.input, l = r + 1; l < q(d, !0) + 1; l++)m = o().validPositions[l], m && !0 !== m.generatedInput && /[0-9a-bA-Z]/.test(m.input) ? u.push(m.input) : l < b && w++, delete o().validPositions[l];
                                        ...
                                        if (t) {
                                            ...
                                            var D = q(b) + 1;
                                            for (l = r + 1; l < q() + 1; l++)((m = o().validPositions[l]) === d || null == m.match.fn) && l < b + (y - w) && y++;
                ...
                return u.pos === d && (u.pos = n), !1 === u && (p(!0), o().validPositions = a.extend(!0, {}, x)), u
            }
            ...
            function E(a, b) {
                var c = o().maskLength;
                if (a >= c)return c;
                for (var d = a; ++d < c && (!0 === b && (!0 !== u(d).match.newBlockMarker || !D(d)) || !0 !== b && !D(d)););
                return d
            }
            ...
            function F(a, b) {
                var c, d = a;
                if (d <= 0)return 0;
                for (; --d > 0 && (!0 === b && !0 !== u(d).match.newBlockMarker || !0 !== b && !D(d) && (c = w(d), c.length < 2 || 2 === c.length && "" === c[1].match.def)););
                return d
            }
            ...
            function I(b, c, e) {
                if (c = c || u(b).match, c.placeholder !== d || !0 === e)return a.isFunction(c.placeholder) ? c.placeholder(i) : c.placeholder;
                if (null === c.fn) {
                    if (b > -1 && o().validPositions[b] === d) {
                        var f, g = w(b), h = [];
                        if (g.length > 1 + ("" === g[g.length - 1].match.def ? 1 : 0))for (var j = 0; j < g.length; j++)if (!0 !== g[j].match.optionality && !0 !== g[j].match.optionalQuantifier && (null === g[j].match.fn || f === d || !1 !== g[j].match.fn.test(f.match.def, o(), b, !0, i)) && (h.push(g[j]), null === g[j].match.fn && (f = g[j]), h.length > 1 && /[0-9a-bA-Z]/.test(h[0].match.def)))return i.placeholder.charAt(b % i.placeholder.length)
                    }
                    return c.def
                }
            ...
            function J(b, f, g, h, j) {
                ...
                if (p(), o().p = E(-1), !g)if (!0 !== i.autoUnmask) {
                ...
                if (a.each(l, function (c, e) {
                        if (e !== d) {
                            ...
                            if (!k(n, m) || g || i.autoUnmask) {
                                ...
                                r = ca.keypressEvent.call(b, f, !0, !1, g, s), n = s + 1, m = ""
                            ...
                            if (!g && a.isFunction(i.onBeforeWrite)) {
                                ...
                                if (r = i.onBeforeWrite(f, y(), r.forwardPosition, i), r.forwardPosition = u, r && r.refreshFromBuffer) {
                                    ...
                                    z(!0 === v ? v : v.start, v.end, r.buffer), p(!0), r.caret && (o().p = r.caret, r.forwardPosition = r.caret)
                                }
                            }
                        }
                    }), f) {
                    var w = d;
                    c.activeElement === b && r && (w = i.numericInput ? F(r.forwardPosition) : r.forwardPosition), H(b, y(), w, j || new a.Event("checkval"), j && "input" === j.type)
                }
            }
            ...
            function L(a, e, f, g) {
                ...
                if (a.scrollLeft = l > a.scrollWidth ? l : 0, j || !1 !== i.insertMode || e !== f || f++, a.setSelectionRange)a.selectionStart = e, a.selectionEnd = f; else if (b.getSelection) {
            ...
            function N(a) {
                for (var b, c = M(), d = a.length; c < d && !D(c + 1) && (b = u(c + 1)) && !0 !== b.match.optionality && !0 !== b.match.optionalQuantifier;)c++;
            ...
            function O(b) {
                ...
                if (e.def === d || e.def.newBlockMarker || e.def.optionality || e.def.optionalQuantifier) {
                    ...
                    for (var g = 0; g <= f; g++) {
                        var h = t(g).match;
                        if (null !== h.fn && o().validPositions[g] === d && !0 !== h.optionality && !0 !== h.optionalQuantifier || null === h.fn && b[g] !== I(g, h)) {
                            c = !1;
                            break
                        }
                    }
            ...
            function P(b, c, f, g) {
                ...
                c === e.keyCode.BACKSPACE && (f.end - f.begin < 1 || !1 === i.insertMode) ? (f.begin = F(f.begin), o().validPositions[f.begin] === d || o().validPositions[f.begin].input !== i.groupSeparator && o().validPositions[f.begin].input !== i.radixPoint || f.begin--) : c === e.keyCode.DELETE && f.begin === f.end && (f.end = D(f.end, !0) ? f.end + 1 : E(f.end) + 1, o().validPositions[f.begin] === d || o().validPositions[f.begin].input !== i.groupSeparator && o().validPositions[f.begin].input !== i.radixPoint || f.end++), r(f.begin, f.end, !1, g), !0 !== g && function () {
                    if (i.keepStatic) {
                        for (var c = [], e = q(-1, !0), f = a.extend(!0, {}, o().validPositions), g = o().validPositions[e]; e >= 0; e--) {
                            var h = o().validPositions[e];
                            if (h) {
                                if (!0 !== h.generatedInput && /[0-9a-bA-Z]/.test(h.input) && c.push(h.input), delete o().validPositions[e], h.alternation !== d && h.locator[h.alternation] !== g.locator[h.alternation])break;
                                g = h
                            }
                        }
                        if (e > -1)for (o().p = E(q(-1, !0)); c.length > 0;) {
                            var j = new a.Event("keypress");
                            j.which = c.pop().charCodeAt(0), ca.keypressEvent.call(b, j, !0, !1, !1, o().p)
            ...
            function Q(d) {
                function e(a) {
                    ...
                    for (var f in h)isNaN(f) && -1 !== f.indexOf("font") && (e.style[f] = h[f]);
                ...
                for (var j in h)h.hasOwnProperty(j) && isNaN(j) && "cssText" !== j && -1 == j.indexOf("webkit") && (V.style[j] = h[j]);
            ...
            var S, T, U, V, W, X = this.el, Y = this.isRTL, Z = !1, $ = !1, _ = !1, aa = !1, ba = {
                on: function (b, c, f) {
                    var g = function (b) {
                        if (this.inputmask === d && "FORM" !== this.nodeName) {
                            ...
                            if ("setvalue" === b.type || "FORM" === this.nodeName || !(this.disabled || this.readOnly && !("keydown" === b.type && b.ctrlKey && 67 === b.keyCode || !1 === i.tabThrough && b.keyCode === e.keyCode.TAB))) {
                                ...
                                return !1 === j && (b.preventDefault(), b.stopPropagation()), j
                            }
                            b.preventDefault()
                        }
                    };
                ...
                keydownEvent: function (b) {
                    var d = this, f = a(d), g = b.keyCode, h = L(d);
                    if (g === e.keyCode.BACKSPACE || g === e.keyCode.DELETE || l && g === e.keyCode.BACKSPACE_SAFARI || b.ctrlKey && g === e.keyCode.X && !function (a) {
                        ...
                        b.preventDefault();
                        var j = E(q());
                        i.insertMode || j !== o().maskLength || b.shiftKey || j--, L(d, b.shiftKey ? h.begin : j, j, !0)
                    ...
                    }, 0)) : (i.insertMode = !i.insertMode, L(d, i.insertMode || h.begin !== o().maskLength ? h.begin : h.begin - 1));
                    i.onKeyDown.call(this, b, y(), L(d).begin, i), _ = -1 !== a.inArray(g, i.ignorables)
                }, keypressEvent: function (b, c, f, g, h) {
                    var j = this, k = a(j), l = b.which || b.charCode || b.keyCode;
                    if (!(!0 === c || b.ctrlKey && b.altKey) && (b.ctrlKey || b.metaKey || _))return l === e.keyCode.ENTER && S !== y().join("") && (S = y().join(""), setTimeout(function () {
                        k.trigger("change")
                    }, 0)), !0;
                    if (l) {
                        46 === l && !1 === b.shiftKey && "" !== i.radixPoint && (l = i.radixPoint.charCodeAt(0));
                        var m, n = c ? {begin: h, end: h} : L(j), q = String.fromCharCode(l);
                        o().writeOutBuffer = !0;
                        var r = C(n, q, g);
                        if (!1 !== r && (p(!0), m = r.caret !== d ? r.caret : c ? r.pos + 1 : E(r.pos), o().p = m), !1 !== f) {
                            var s = this;
                            if (setTimeout(function () {
                                    i.onKeyValidation.call(s, l, r, i)
                                }, 0), o().writeOutBuffer && !1 !== r) {
                                var t = y();
                                H(j, t, i.numericInput && r.caret === d ? F(m) : m, b, !0 !== c), !0 !== c && setTimeout(function () {
                                    !0 === O(t) && k.trigger("complete")
                                }, 0)
                            }
                        }
                    ...
                    if (k === (Y ? x().reverse() : x()).slice(0, j.begin).join("") && (k = ""), l === (Y ? x().reverse() : x()).slice(j.end).join("") && (l = ""), Y && (d = k, k = l, l = d), b.clipboardData && b.clipboardData.getData)h = k + b.clipboardData.getData("Text") + l; else {
                    ...
                    if (y().join("") !== d) {
                        ...
                        if ("." === d.charAt(f.begin - 1) && "" !== i.radixPoint && (d = d.split(""), d[f.begin - 1] = i.radixPoint.charAt(0), d = d.join("")), d.charAt(f.begin - 1) === i.radixPoint && d.length > y().length) {
                            ...
                            return g.which = i.radixPoint.charCodeAt(0), ca.keypressEvent.call(c, g, !0, !0, !1, f.begin), !1
                        }
                        if (d = d.replace(new RegExp("(" + e.escapeRegex(x().join("")) + ")*"), ""), k) {
                            var h = d.replace(y().join(""), "");
                            if (1 === h.length) {
                                var g = new a.Event("keypress");
                                return g.which = h.charCodeAt(0), ca.keypressEvent.call(c, g, !0, !0, !1, o().validPositions[f.begin - 1] ? f.begin : f.begin - 1), !1
                            }
                        }
                        if (f.begin > d.length && (L(c, d.length), f = L(c)), y().length - d.length != 1 || d.charAt(f.begin) === y()[f.begin] || d.charAt(f.begin + 1) === y()[f.begin] || D(f.begin)) {
                            ...
                            if (0 === r && p !== j[0].length)L(c, j[0].length), m && setTimeout(function () {
                                ...
                                var s = q.indexOf(j[1]);
                                -1 !== s && "" !== j[1] && p > s && s > r && (L(c, s), m && setTimeout(function () {
                                    L(c, s)
                                }, 0))
                            }
                            !0 === O(y()) && a(c).trigger("complete")
                        } else b.keyCode = e.keyCode.BACKSPACE, ca.keydownEvent.call(c, b);
                        b.preventDefault()
                    }
                }, setValueEvent: function (b) {
                    this.inputmask.refreshValue = !1;
                    var c = this, d = c.inputmask._valueGet(!0);
                    a.isFunction(i.onBeforeMask) && (d = i.onBeforeMask(d, i) || d), d = d.split(""), J(c, !0, !1, Y ? d.reverse() : d), S = y().join(""), (i.clearMaskOnLostFocus || i.clearIncomplete) && c.inputmask._valueGet() === x().join("") && c.inputmask._valueSet("")
                }, focusEvent: function (a) {
                    var b = this, c = b.inputmask._valueGet();
                    i.showMaskOnFocus && (!i.showMaskOnHover || i.showMaskOnHover && "" === c) && (b.inputmask._valueGet() !== y().join("") ? H(b, y(), E(q())) : !1 === aa && L(b, E(q()))), !0 === i.positionCaretOnTab && !1 === aa && ca.clickEvent.apply(b, [a, !0]), S = y().join("")
                }, mouseleaveEvent: function (a) {
                    var b = this;
                    if (aa = !1, i.clearMaskOnLostFocus && c.activeElement !== b) {
                        var d = y().slice(), e = b.inputmask._valueGet();
                        e !== b.getAttribute("placeholder") && "" !== e && (-1 === q() && e === x().join("") ? d = [] : N(d), H(b, d))
                    }
                    ...
                    setTimeout(function () {
                        if (c.activeElement === g) {
                            var a = L(g);
                            if (e && (Y ? a.end = a.begin : a.begin = a.end), a.begin === a.end)switch (i.positionCaretOnClick) {
                                case"none":
                                    break;
                                case"radixFocus":
                                    if (f(a.begin)) {
                                ...
                                default:
                                    ...
                                    if (d < j)L(g, D(d) || D(d - 1) ? d : E(d)); else {
                                        var k = I(j);
                                        ("" !== k && y()[j] !== k && !0 !== u(j).match.optionalQuantifier || !D(j) && u(j).match.def === k) && (j = E(j)), L(g, j)
                                    }
                            }
                        }
                    }, 0)
                    ...
                    var f = this, g = a(f), h = L(f), i = d.originalEvent || d, j = b.clipboardData || i.clipboardData, k = Y ? y().slice(h.end, h.begin) : y().slice(h.begin, h.end);
                    j.setData("text", Y ? k.reverse().join("") : k.join("")), c.execCommand && c.execCommand("copy"), P(f, e.keyCode.DELETE, h), H(f, y(), o().p, d, S !== y().join("")), f.inputmask._valueGet() === x().join("") && g.trigger("cleared")
                }, blurEvent: function (b) {
                    var c = a(this), e = this;
                    if (e.inputmask) {
                        var f = e.inputmask._valueGet(), g = y().slice();
                        S !== g.join("") && setTimeout(function () {
                            c.trigger("change"), S = g.join("")
                        }, 0), "" !== f && (i.clearMaskOnLostFocus && (-1 === q() && f === x().join("") ? g = [] : N(g)), !1 === O(g) && (setTimeout(function () {
                            c.trigger("incomplete")
                        }, 0), i.clearIncomplete && (p(), g = i.clearMaskOnLostFocus ? [] : x().slice())), H(e, g, d, b))
                    }
                }, mouseenterEvent: function (a) {
                    var b = this;
                    aa = !0, c.activeElement !== b && i.showMaskOnHover && b.inputmask._valueGet() !== y().join("") && H(b, y())
            ...
            if (f !== d)switch (f.action) {
                case"isComplete":
                    return X = f.el, O(y());
                case"unmaskedvalue":
                    return X !== d && f.value === d || (W = f.value, W = (a.isFunction(i.onBeforeMask) ? i.onBeforeMask(W, i) || W : W).split(""), J(d, !1, !1, Y ? W.reverse() : W), a.isFunction(i.onBeforeWrite) && i.onBeforeWrite(d, y(), 0, i)), K(X);
                case"mask":
                    !function (b) {
                        ba.off(b);
                        var e = function (b, e) {
                            var f = b.getAttribute("type"), g = "INPUT" === b.tagName && -1 !== a.inArray(f, e.supportsInputType) || b.isContentEditable || "TEXTAREA" === b.tagName;
                            if (!g)if ("INPUT" === b.tagName) {
                                var h = c.createElement("input");
                                h.setAttribute("type", f), g = "text" === h.type, h = null
                            } else g = "partial";
                            return !1 !== g && function (b) {
                                function f() {
                                ...
                                if (!b.inputmask.__valueGet) {
                                    if (!0 !== e.noValuePatching) {
                                        if (Object.getOwnPropertyDescriptor) {
                                            ...
                                            var j = Object.getPrototypeOf ? Object.getOwnPropertyDescriptor(Object.getPrototypeOf(b), "value") : d;
                                        ...
                                        } else c.__lookupGetter__ && b.__lookupGetter__("value") && (h = b.__lookupGetter__("value"), i = b.__lookupSetter__("value"), b.__defineGetter__("value", f), b.__defineSetter__("value", g));
                                    ...
                                    b.inputmask._valueGet = function (a) {
                                            ...
                                            a.valHooks[b] = {
                                                get: function (a) {
                                                    if (a.inputmask) {
                                                        ...
                                                        var b = c(a);
                                                        return -1 !== q(d, d, a.inputmask.maskset.validPositions) || !0 !== e.nullable ? b : ""
                                                    }
                                                    return c(a)
                                                }, set: function (b, c) {
                                                    var d, e = a(b);
                                        ...
                                        ba.on(b, "mouseenter", function (b) {
                                            var c = a(this);
                                            this.inputmask._valueGet() !== y().join("") && c.trigger("setvalue")
                                        })
                                    }(b))
                                }
                            }(b), g
                        }(b, i);
                        if (!1 !== e && (X = b, T = a(X), ("rtl" === X.dir || i.rightAlign) && (X.style.textAlign = "right"), ("rtl" === X.dir || i.numericInput) && (X.dir = "ltr", X.removeAttribute("dir"), X.inputmask.isRTL = !0, Y = !0), !0 === i.colorMask && Q(X), m && (X.hasOwnProperty("inputmode") && (X.inputmode = i.inputmode, X.setAttribute("inputmode", i.inputmode)), "rtfm" === i.androidHack && (!0 !== i.colorMask && Q(X), X.type = "password")), !0 === e && (ba.on(X, "submit", ca.submitEvent), ba.on(X, "reset", ca.resetEvent), ba.on(X, "mouseenter", ca.mouseenterEvent), ba.on(X, "blur", ca.blurEvent), ba.on(X, "focus", ca.focusEvent), ba.on(X, "mouseleave", ca.mouseleaveEvent), !0 !== i.colorMask && ba.on(X, "click", ca.clickEvent), ba.on(X, "dblclick", ca.dblclickEvent), ba.on(X, "paste", ca.pasteEvent), ba.on(X, "dragdrop", ca.pasteEvent), ba.on(X, "drop", ca.pasteEvent), ba.on(X, "cut", ca.cutEvent), ba.on(X, "complete", i.oncomplete), ba.on(X, "incomplete", i.onincomplete), ba.on(X, "cleared", i.oncleared), m || !0 === i.inputEventOnly || (ba.on(X, "keydown", ca.keydownEvent), ba.on(X, "keypress", ca.keypressEvent)), ba.on(X, "compositionstart", a.noop), ba.on(X, "compositionupdate", a.noop), ba.on(X, "compositionend", a.noop), ba.on(X, "keyup", a.noop), ba.on(X, "input", ca.inputFallBackEvent), ba.on(X, "beforeinput", a.noop)), ba.on(X, "setvalue", ca.setValueEvent), x(), "" !== X.inputmask._valueGet(!0) || !1 === i.clearMaskOnLostFocus || c.activeElement === X)) {
                            var f = a.isFunction(i.onBeforeMask) ? i.onBeforeMask(X.inputmask._valueGet(!0), i) || X.inputmask._valueGet(!0) : X.inputmask._valueGet(!0);
                            "" !== f && J(X, !0, !1, Y ? f.split("").reverse() : f.split(""));
                            var g = y().slice();
                            S = g.join(""), !1 === O(g) && i.clearIncomplete && p(), i.clearMaskOnLostFocus && c.activeElement !== X && (-1 === q() ? g = [] : N(g)), H(X, g), c.activeElement === X && L(X, E(q()))
                        }
                    }(X);
                    break;
                case"format":
                    return W = (a.isFunction(i.onBeforeMask) ? i.onBeforeMask(f.value, i) || f.value : f.value).split(""), J(d, !0, !1, Y ? W.reverse() : W), f.metadata ? {
                        value: Y ? y().slice().reverse().join("") : y().join(""),
                        metadata: h.call(this, {action: "getmetadata"}, g, i)
                    } : Y ? y().slice().reverse().join("") : y().join("");
                case"isValid":
                    f.value ? (W = f.value.split(""), J(d, !0, !0, Y ? W.reverse() : W)) : f.value = y().join("");
                    for (var da = y(), ea = M(), fa = da.length - 1; fa > ea && !D(fa); fa--);
                    return da.splice(ea, fa + 1 - ea), O(da) && f.value === y().join("");
                case"getemptymask":
                    return x().join("");
                case"remove":
                    if (X && X.inputmask) {
                        T = a(X), X.inputmask._valueSet(i.autoUnmask ? K(X) : X.inputmask._valueGet(!0)), ba.off(X);
                        Object.getOwnPropertyDescriptor && Object.getPrototypeOf ? Object.getOwnPropertyDescriptor(Object.getPrototypeOf(X), "value") && X.inputmask.__valueGet && Object.defineProperty(X, "value", {
                            ...
                            configurable: !0
                        }) : c.__lookupGetter__ && X.__lookupGetter__("value") && X.inputmask.__valueGet && (X.__defineGetter__("value", X.inputmask.__valueGet), X.__defineSetter__("value", X.inputmask.__valueSet)), X.inputmask = d
                    }
                    return X;
                case"getmetadata":
        ...
        return e.prototype = {
            ...
            option: function (b, c) {
                return "string" == typeof b ? this.opts[b] : "object" == typeof b ? (a.extend(this.userOptions, b), this.el && !0 !== c && this.mask(this.el), this) : void 0
            },
            ...
            analyseMask: function (b, c, f) {
                ...
                function k(a) {
                    ...
                    for (var b in a.matches)if (a.matches.hasOwnProperty(b)) {
                        var c = parseInt(b);
                ...
                for (c && (f.optionalmarker.start = d, f.optionalmarker.end = d); l = c ? t.exec(b) : s.exec(b);) {
                    ...
                    if (u)j(); else switch (m.charAt(0)) {
                        ...
                        case f.alternatormarker:
                            ...
                            if (q.isAlternator)w.push(q); else if (q.alternatorGroup ? (p = w.pop(), q.alternatorGroup = !1) : p = new g(!1, !1, !1, !0), p.matches.push(q), w.push(p), q.openGroup) {
                                q.openGroup = !1;
                                var F = new g(!0);
    ...
    !function (a, b) {
        void 0 === a.fn.inputmask && (a.fn.inputmask = function (c, d) {
            var e, f = this[0];
        ...
        b.extendAliases({
            ...
            datetime: {
                ...
                definitions: {
                    h: {
                        validator: function (a, b, c, d, e) {
                            if ("24" === e.hourFormat && 24 === parseInt(a, 10))return b.buffer[c - 1] = "2", b.buffer[c] = "0", {
                                refreshFromBuffer: {
                                    start: c - 1,
                                    end: c
                                }, c: "4"
            ...
            "hh:mm": {mask: "h:s", placeholder: "hh:mm", alias: "datetime", autoUnmask: !0},
        ...
        b.extendAliases({
            numeric: {
                mask: function (a) {
                    ...
                    var f = "[+]";
                    if (f += d(a.prefix, a),
                            !0 === a.integerOptional ? f += "~{1," + a.integerDigits + "}" : f += "~{" + a.integerDigits + "}", a.digits !== c) {
                ...
                preValidation: function (b, d, e, f, g) {
                    ...
                    if (!1 === f && e === g.radixPoint && g.digits !== c && (isNaN(g.digits) || parseInt(g.digits) > 0)) {
                        ...
                        if (-1 !== h)return !0 === g.numericInput ? d === h : {caret: h + 1}
                    }
                    return !0
                },
                postValidation: function (d, e, f) {
                    var g = f.suffix.split(""), h = f.prefix.split("");
                    if (e.pos == c && e.caret !== c && !0 !== e.dopost)return e;
                    var i = e.caret != c ? e.caret : e.pos, j = d.slice();
                    ...
                    if (l = l.replace(g, ""), l = l.replace(new RegExp(b.escapeRegex(f.groupSeparator), "g"), ""), l = l.replace(new RegExp("[-" + b.escapeRegex(f.negationSymbol.front) + "]", "g"), ""), l = l.replace(new RegExp(b.escapeRegex(f.negationSymbol.back) + "$"), ""), isNaN(f.placeholder) && (l = l.replace(new RegExp(b.escapeRegex(f.placeholder), "g"), "")), l.length > 1 && 1 !== l.indexOf(f.radixPoint) && ("0" == k && (l = l.replace(/^\?/g, "")), l = l.replace(/^0/g, "")), l.charAt(0) === f.radixPoint && !0 !== f.numericInput && (l = "0" + l), "" !== l) {
                        if (l = l.split(""), !f.digitsOptional && isFinite(f.digits)) {
                            var m = a.inArray(f.radixPoint, l), n = a.inArray(f.radixPoint, j);
                            -1 === m && (l.push(f.radixPoint), m = l.length - 1);
                            for (var o = 1; o <= f.digits; o++)f.digitsOptional || l[m + o] !== c && l[m + o] !== f.placeholder.charAt(0) ? -1 !== n && j[n + o] !== c && (l[m + o] = l[m + o] || j[n + o]) : l[m + o] = e.placeholder || f.placeholder.charAt(0)
                        }
                        ...
                        }).format(l.join("")), l.charAt(0) === f.groupSeparator && l.substr(1))
                    }
                    ...
                    if (d)switch (d.type) {
                        ...
                        case"checkval":
                            ...
                            if (function (a) {
                                ...
                                if (h = g.onUnMask(e.join(""), c, a.extend({}, g, {unmaskAsNumber: !0})), null !== g.min && h < g.min)return g.isNegative = g.min < 0, g.postValidation(g.min.toString().replace(".", g.radixPoint).split(""), {
                                    caret: f,
                                    dopost: !0,
                                    placeholder: "0"
                                }, g);
                ...
                definitions: {
                    "~": {
                        ...
                        validator: function (a, c, d, e, f) {
                            var g = "[" + b.escapeRegex(f.radixPoint) + "]", h = new RegExp(g).test(a);
                            return h && c.validPositions[d] && c.validPositions[d].match.placeholder === f.radixPoint && (h = {caret: d + 1}), h
                ...
                onUnMask: function (a, c, d) {
                    ...
                    return e = e.replace(d.suffix, ""), e = e.replace(new RegExp(b.escapeRegex(d.groupSeparator), "g"), ""), "" !== d.placeholder.charAt(0) && (e = e.replace(new RegExp(d.placeholder.charAt(0), "g"), "0")), d.unmaskAsNumber ? ("" !== d.radixPoint && -1 !== e.indexOf(d.radixPoint) && (e = e.replace(b.escapeRegex.call(this, d.radixPoint), ".")), Number(e)) : e
                },
                ...
                canClearPosition: function (a, b, c, d, e) {
                    var f = a.validPositions[b], g = f.input !== e.radixPoint || null !== a.validPositions[b].match.fn && !1 === e.decimalProtect || f.input === e.radixPoint && a.validPositions[b + 1] && null === a.validPositions[b + 1].match.fn || isFinite(f.input) || b === c || f.input === e.groupSeparator || f.input === e.negationSymbol.front || f.input === e.negationSymbol.back;
                        ...
                        validator: function (b, c, d, e, f) {
                            ...
                            function h(b, c) {
                                ...
                                for (var e = 0; e < b.matches.length; e++) {
                                    var g = b.matches[e];
                                    if (!0 === g.isGroup)d = h(g, !0); else if (!0 === g.isQuantifier) {
                                        var j = a.inArray(g, b.matches), k = b.matches[j - 1], m = l;
                                        if (isNaN(g.quantifier.max)) {
                                            for (; g.repeaterPart && g.repeaterPart !== l && g.repeaterPart.length > l.length && !(d = h(k, !0)););
                                            d = d || h(k, !0), d && (g.repeaterPart = l), l = m + g.quantifier.max
                                        } else {
                                            for (var o = 0, p = g.quantifier.max - 1; o < p && !(d = h(k, !0)); o++);
                                            l = m + "{" + g.quantifier.min + "," + g.quantifier.max + "}"
                                        }
                                        ...
                                        if ("[" == g.charAt(0)) {
                                            ...
                                            r = l, r += g.substr(0, u + 1), r = r.replace(/\|$/, "");
                                            for (var s = 0; s < n; s++)r += ")";
                                            var t = new RegExp("^(" + r + ")$", f.casing ? "i" : "");
                                            if (d = t.test(i))break
                                        }
                            ...
                            var i, j, k = c.buffer.slice(), l = "", m = !1, n = 0;
                            null === f.regexTokens && function () {
                                var a, b, c = new g, d = [];
                                for (f.regexTokens = []; a = f.tokenizer.exec(f.regex);)switch (b = a[0], b.charAt(0)) {
                                    ...
                                    case"*":
                                        ...
                                        if (e.quantifier = {min: i, max: k}, d.length > 0) {
                            ...
                            }(), k.splice(d, 0, b), i = k.join("");
                            for (var o = 0; o < f.regexTokens.length; o++) {
                                var p = f.regexTokens[o];
                                if (m = h(p, p.isGroup))break
                            }
                            return m
                        }, cardinality: 1
                    }
